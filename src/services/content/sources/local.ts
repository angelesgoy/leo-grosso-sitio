...
export const pendingSocialRecords: LocalContentRecord[] = [
  {
    ...
    authorName: 'Leo Grosso', authorHandle: '@leon_grosso', verified: false,
  ...
  },
  {
    ...
    authorName: 'Leo Grosso', authorHandle: '@leo.grosso', verified: false,
    editorialStatus: 'reviewed', integrationStatus: 'pending', provider: 'Configuración local'
  },
  {
    ...
    authorName: 'Leo Grosso', authorHandle: '@Leonardo_Grosso', verified: false,
    editorialStatus: 'reviewed', integrationStatus: 'pending', provider: 'Configuración local'
  },
  {
    ...
    authorName: 'Leo Grosso', authorHandle: 'grossoleonardo', verified: false,
    editorialStatus: 'reviewed', integrationStatus: 'pending', provider: 'Configuración local'
  }
];
